    ...
    if request.method == 'GET':
        ...
        if regform.is_valid():
            try:
                ...
                if User_count > 0:
                    return HttpResponse('пользователь с таким Login существует в базе, не взламывайте его перебором паролей пожалуйста 😏!!!')
                else:
                    user = Users()
                ...
                return  HttpResponse('упс, где-то произошла ошибочка 😨')
        ...
        if loginform.is_valid():
            try:
                ...
                if len(User_count) > 0:
                    ...
                    return  HttpResponse('такого пользователя нет ️‍🐒️ или пароль неправильный 🐒')
